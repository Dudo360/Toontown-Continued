...
class DistributedBlackFridayVPBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedBlackFridayVPBoss')
    cageHeights = [100,
     81,
     63,
     44,
    ...
    def __init__(self, cr):
        ...
        FSM.FSM.__init__(self, 'DistributedBlackFridayVPBoss')
