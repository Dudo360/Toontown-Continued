...
class DistributedBlackFridayVPBossAI(DistributedBossCogAI.DistributedBossCogAI, FSM.FSM):
    notify = DirectNotifyGlobal.directNotify.newCategory('DistributedBlackFridayVPBossAI')
    limitHitCount = 6
    numPies = ToontownGlobals.FullPies

    def __init__(self, air):
        DistributedBossCogAI.DistributedBossCogAI.__init__(self, air, 's')
        FSM.FSM.__init__(self, 'DistributedBlackFridayVPBossAI')
        self.doobers = []
    ...
    def getDamageMultiplier(self):
        if self.nerfed:
            ...
            return SellbotBossGlobals.AttackFriday
